    ...
    <Teleport to="body">
        <Transition enter-active-class="transition ease-out duration-300" enter-from-class="translate-x-full"
            ...
            <div v-if="isOpen" ref="panelRef"
                class="fixed inset-y-0 right-0 w-[480px] bg-white shadow-xl flex flex-col z-[100]">
                <!-- Header -->
                <div class="bg-teal-600 text-white">
                    ...
                    <div class="px-6 pb-4 text-sm text-white/90">
                        Fill in the information below to create your new bot. Once created you can add source
                        documentation
                        and
                                ...
                                <div class="space-y-4">
                                    <label class="flex items-center">
                                        ...
                                        <span class="ml-3">
                                            ...
                                            <span class="block text-sm text-gray-500">Allows for embedding on the
                                                frontend
                                                of
                                                websites.</span>
                                        </span>
                                    ...
                                    <label class="flex items-center">
                                        ...
                                        <span class="ml-3">
                                            ...
                                            <span class="block text-sm text-gray-500">Authenticated API access only.
                                                Good
                                                for
                                ...
                                <div class="space-y-4">
                                    <label class="flex items-center">
                                        ...
                                        <span class="ml-3">
                                            ...
                                            <span class="block text-sm text-gray-500">
                                                ...
                                                <a href="#" class="ml-1 text-teal-600 hover:text-teal-700">Get
                                                    access</a>
                                            </span>
                                        </span>
                                    </label>
                                    ...
                                    <label class="flex items-center">
                                        <input type="radio" v-model="model" value="gpt-4-mini"
                                            class="h-4 w-4 text-teal-600 focus:ring-2 focus:ring-teal-500 border-gray-300" />
                                        <span class="ml-3">
                                            <span class="block text-sm font-medium text-gray-900">GPT-4o Mini - Best
                                                Value
                                                <span
                ...
                <div class="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-200/60 px-6 py-4">
                    <div class="flex justify-end space-x-3">
                        ...
                        <button type="button" @click="handleCreate" data-create-bot
...
const handleClickOutside = (event) => {
    ...
    const isClickInside = panelRef.value.contains(event.target)
    const isCreateBotButton = event.target.closest('[data-create-bot]')

    if (!isClickInside && !isCreateBotButton && props.isOpen) {
        handleClose()
    }
}
...
const handleCreate = () => {
    ...
    emit('create', botData)
    resetForm()
    handleClose() // Use the existing close handler instead of emitting directly
}
